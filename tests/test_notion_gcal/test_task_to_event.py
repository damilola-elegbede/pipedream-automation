    ...
    mock_steps = {
        "trigger": {
            "event": {
                ...
                "properties": {
                    "Due Date": {"date": {"start": start_date, "end": end_date}},
...
def test_handler_missing_due_date():
    mock_steps = {
        "trigger": {
            "event": {
                "properties": {"Task name": {"title": [{"plain_text": "Test Task"}]}}
            }
        }
    }
        ...
        "trigger": {
            "event": {
                "properties": {
                    ...
                    "Task name": {"title": [{"plain_text": "Test Task"}]},
                    "Google Event ID": {"rich_text": ["existing-event-id"]},
                }
            }
        }
    }
...
def test_handler_untitled_task():
    ...
    mock_steps = {
        "trigger": {
            "event": {
                "properties": {
                    "Due Date": {"date": {"start": start_date}},
                    "Task name": {"title": []},
                    "Google Event ID": {"rich_text": []},
                }
            }
